...
function Login() {
  ...
  return (
    ...
    // </div>
    <>
    {showForgetPassword ? <ForgotPassword showForgetPassword={showForgetPassword} setshowForgetPassword={setshowForgetPassword} /> :  <div className="md:min-h-screen  h-screen login-main md:flex md:p-0 p-4 items-center justify-center ">
    <div className="md:w-2/3 h-96 login-child-main md:flex">
      ...
      <div style={{ height: "100%" }} className="md:w-1/2  login-form-bg md:ml-28 max-w-md rounde shadow-md">
        ...
        <form onSubmit={handleSubmit} className="p-8 ">
          ...
          <div className=" mt-8">
            <p onClick={()=>setshowForgetPassword(true)} className="cursor-pointer text-xs hover:underline">Forgot Password?</p>
          </div>
