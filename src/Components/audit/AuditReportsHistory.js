    ...
    return (
        ...
        <div className="absolute h-full inset-0 bg-black/20 backdrop-blur-xs flex items-center justify-center z-50">
          <div className="relative w-20 h-20">
            ...
            <GlobalBackTab title="Audit Reports History" />
            {isloading && (
                ...
                {Fileurl_vendor?.name && (
                  <span className="text-white text-sm md:text-base truncate max-w-[150px]">
                    {Fileurl_vendor.name}
                        ...
                        <h1 className="text-white text-2xl mt-4">Vendor Files</h1>
                ...
                {Fileurl_billing?.name && (
                  <span className="text-white text-sm md:text-base truncate max-w-[150px]">
                    {Fileurl_billing.name}
                        ...
                        <h1 className="text-white text-2xl mt-4">Billing Files</h1>
              ...
              {File_balance?.name && (
                <span className="text-white text-sm md:text-base truncate max-w-[150px]">
                  {File_balance.name}
                    ...
                    <h1 className="text-white text-2xl mt-4">Balance Files</h1>
